...
// --- wagmi config: injected only (Rabby desktop, MetaMask, etc.) ---
export const config = createConfig({
  chains: [sei],
  transports: { [sei.id]: http("https://evm-rpc.sei-apis.com") },
  connectors: [
    injected({
      shimDisconnect: true, // keeps RainbowKit's disconnect state sane
    }),
  ],
});
...
// --- reusable connect button used in your header + mobile menu ---
